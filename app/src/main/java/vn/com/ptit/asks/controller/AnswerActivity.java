        ...
        if (content.trim().length() < 1) {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, this.createAnswerUrl, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    try {
                        ...
                        if (code == 700) {
                            ...
                            Intent changeView = new Intent(AnswerActivity.this, QuestionDetailActivity.class);
                ...
                public Map<String, String> getHeaders() throws AuthFailureError {
                    ...
                    SharedPreferences sharePrefs = AnswerActivity.this.getApplicationContext().getSharedPreferences("ASKS", MODE_PRIVATE);
