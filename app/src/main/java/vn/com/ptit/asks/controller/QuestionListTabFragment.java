...
import www.seotoolzz.com.asks.adapter.QuestionListAdapter;
import www.seotoolzz.com.asks.R;
import www.seotoolzz.com.asks.model.Question;
...
public class QuestionListTabFragment extends Fragment {
    ...
    public static QuestionListTabFragment newInstance(int pageNo) {

        Bundle args = new Bundle();
        args.putInt(ARG_PAGE, pageNo);
        QuestionListTabFragment fragment = new QuestionListTabFragment();
